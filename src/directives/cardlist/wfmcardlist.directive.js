(function() {
	...
	function getWfmCardTemplate() {
		return (
			"<md-card ng-class=\"vm.isSelected() ? 'wfm-card-selected material-depth-2' : 'wfm-card-unselected' \">" +
	...
	angular.module('wfm.cardList').controller('wfmCardListCtrl', function() {
		var vm = this;
		vm.selectedCards = {};
	...
	function getWfmCardListTemplate() {
		return (
			'<md-content class="wfm-card-list-container">' +
	...
	angular.module('wfm.cardList').directive('wfmCardList', function() {
		return {
