	...
	function timeRangePicker($filter) {
		...
		function postlink(scope, elem, attrs, ctrls) {
			...
			function formatModel(modelValue) {
				...
				var nextDay = !timeRangeCtrl.sameDate(modelValue.startTime, modelValue.endTime);

				var viewModel = makeViewValue(modelValue.startTime, modelValue.endTime, nextDay);
			...
			function respondToUIChange(change, old) {
				...
				ngModel.$setViewValue(makeViewValue(scope.startTime, scope.endTime, scope.nextDay));
			}
