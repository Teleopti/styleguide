describe('wfm-multiple-search-input directive', function() {
	...
	beforeEach(
		inject(function(_$compile_, _$rootScope_) {
			...
			var elementCompile = _$compile_(
				'<wfm-multiple-search-input search-title="\'Filter people\'" search-options="searchOptions" search-callback="searchKeyword"></wfm-multiple-search-input>'
			);
	...
	it(
		'should parse terms correctly by search with option',
		inject(function() {
	...
	it(
		'should handle both single quote and double quote in search value correctly',
		inject(function() {
	...
	it(
		'should handle comma in search value correctly',
		inject(function() {
	...
	it(
		'should change the advanced search field according to simple search input',
		inject(function() {
	...
	it(
		'should clear the advanced search field and simple search input when click clear button',
		inject(function() {
			vm.searchOptions.keyword = 'FirstName: Ashley Smith; Organization: London Shenzhen';
			vm.validateSearchKeywordChanged();
			vm.clearSearch();
