	...
	wfmNotice.directive('wfmNotice', [
		...
		function($timeout, $rootScope) {
			return {
				...
				template:
					'<div ng-repeat="notice in notices"><div class="notice-container"><div class="notice-item" ng-class="setType(notice)"><i ng-class="setIcon(notice)"></i><span ng-bind-html="notice.content"></span> <i class="pull-right mdi mdi-close notice-close" ng-click="deleteNotice(notice)"></i></div></div></div>' +
