(function() {
	...
	describe('wfmNotice', function() {
		var elementCompile, rootScope, directiveScope;
		...
		it(
			'should display a notice created with NoticeService',
		...
		it(
			'should display a newly added notice',
			inject(function($compile, $injector) {
				var element = '<wfm-notice notices="wfmNotices"></wfm-notice>';
				elementCompile = $compile(element)(rootScope);
				var noticeService = $injector.get('NoticeService', {
		...
		it(
			'should display not add a existing notice',
			inject(function($compile, $injector) {
				var element = '<wfm-notice notices="wfmNotices"></wfm-notice>';
				elementCompile = $compile(element)(rootScope);
				var noticeService = $injector.get('NoticeService', {
		...
		it(
			'should remove the correct notice on call',
			inject(function($compile, $injector) {
				var element = '<wfm-notice notices="wfmNotices"></wfm-notice>';
				elementCompile = $compile(element)(rootScope);
				var noticeService = $injector.get('NoticeService', {
		...
		it(
			'should destroy notices on state changes',
			inject(function($compile, $injector) {
				var element = '<wfm-notice notices="wfmNotices"></wfm-notice>';
				elementCompile = $compile(element)(rootScope);
				var noticeService = $injector.get('NoticeService', {
